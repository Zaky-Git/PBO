...
public class Plane extends kendaraan {
    ...
    public Plane(int xLoc, int yLoc, int Speed) {
        this.xLoc = xLoc;
        this.yLoc = yLoc;
        this.Speed = Speed;
    ...
    public void move(int xLoc, int yLoc) {
        this.xLoc = xLoc;
        this.yLoc = yLoc;
        System.out.println("Pesawat berpindah " + xLoc + " " + yLoc);
    ...
    public void accelerat(int Speed) {
        if (Speed > this.Speed) {
            ...
            System.out.println("Pesawat bertambah kecepatan sebanyak " + this.Speed);
        }
    }
